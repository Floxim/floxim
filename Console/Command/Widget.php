...
class Widget extends Console\Command
{
    ...
    public function doScaffold($id, $overwrite = false)
    {
        $widget = fx::data('widget', $id);
        $this->scaffold($widget, $overwrite);
    }
