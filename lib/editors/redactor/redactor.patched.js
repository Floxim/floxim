			...
			return {
				...
				createMarkers: function()
				{
					...
					if (this.range.collapsed === false)
					{
                        ...
                        this.selection.restoreButSaveMarkers();
					}
                ...
                restoreButSaveMarkers: function() {
                    var node1 = this.$editor.find('span#selection-marker-1');
                    var node2 = this.$editor.find('span#selection-marker-2');
				...
				normalize: function()
				{
					...
					var containerNode = this.range.startContainer;
					if (
						containerNode.nodeType === Node.ELEMENT_NODE
						&& containerNode.childNodes[ this.range.startOffset ]
					) 
					{
						this.range.setStart(containerNode.childNodes[ this.range.startOffset ], 0);
						this.range.collapse();
					...
					{
						this.range.startContainer.parentNode.normalize();
					}
				},
				/* eof dubrowsky hotfix */
				getText: function()
