...
class Lang extends Admin
{
    ...
    public function add($input)
    {
        ...
        $this->response->breadcrumb->addItem(fx::alang('Languages', 'system'), '#admin.administrate.lang.all');
        $this->response->breadcrumb->addItem(fx::alang('Add new language', 'system'));
    ...
    public function addSave($input)
    {
        ...
        $lang = fx::data('lang')->create(array(
